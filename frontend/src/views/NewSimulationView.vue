...
const plano72h = computed(() => {
  return [
    ...
    `Monitorar risco reputacional (meta: < ${metricasExecutivas.value.riscoReputacional}%) e ajustar comunicação diariamente.`
  ]
})
const resumoExecutivo = computed(() => {
  return [
    ...
    `Adoção prevista: ${metricasExecutivas.value.adocao}%`,
    `Risco reputacional: ${metricasExecutivas.value.riscoReputacional}%`,
    `Confiança da recomendação: ${metricasExecutivas.value.confianca}%`,
    'Plano 72h:',
        ...
        <div class="card summary-card">
          ...
          <div class="exec-panel">
            ...
            <div class="exec-metrics">
              <div class="exec-chip">Adoção prevista: <strong>{{ metricasExecutivas.adocao }}%</strong></div>
              <div class="exec-chip">Risco reputacional: <strong>{{ metricasExecutivas.riscoReputacional }}%</strong></div>
              <div class="exec-chip">Confiança da recomendação: <strong>{{ metricasExecutivas.confianca }}%</strong></div>
            </div>

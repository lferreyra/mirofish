    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          <span class="step-num">{{ $t('reportView.stepNum') }}</span>
...
const statusText = computed(() => {
  if (currentStatus.value === 'error') return t('reportView.status.error')
  if (currentStatus.value === 'completed') return t('reportView.status.completed')
  return t('reportView.status.generating')
})

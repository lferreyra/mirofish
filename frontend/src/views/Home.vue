      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine standing by. Upload multiple unstructured data files to initialize the simulation sequence.
          </p>
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Avg. $5/simulation run</div>
            </div>
            <div class="metric-card">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirements in natural language (e.g., What would happen if...)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk as heading font, JetBrains Mono for code/label font
...
/* Guiding animation: subtle border pulse */

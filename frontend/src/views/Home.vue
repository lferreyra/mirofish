      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby, can upload multiple unstructured data files to initialize simulation sequence
          </p>
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Up to 1M Agents simulation</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relationship extraction & persona generation & environment config Agent injection</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any agent in the simulation world & chat with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirement in natural language (e.g. If Wuhan University issues an announcement revoking X's punishment, what public opinion trends will it cause)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - jump immediately, API call is done in Process page
const startSimulation = () => {
  if (!canSubmit.value || loading.value) return

  // Store data to upload
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    setPendingUpload(files.value, formData.value.simulationRequirement)

    // Jump to Process page immediately (use special flag to indicate new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Use Space Grotesk as main title font, JetBrains Mono as code/tag font

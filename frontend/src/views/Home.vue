    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              {{ $t('home.descPart1') }}<span class=”highlight-bold”>MiroFish</span>{{ $t('home.descPart2') }}<span class=”highlight-orange”>{{ $t('home.descPart3') }}</span>{{ $t('home.descPart4') }}<span class=”highlight-code”>{{ $t('home.descPart5') }}</span>
            </p>
            <p class=”slogan-text”>
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">{{ $t('home.consoleSeedLabel') }}</span>
                <span class="console-meta">{{ $t('home.consoleSeedFormats') }}</span>
              </div>
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-title">{{ $t('home.uploadDragTitle') }}</div>
                  <div class="upload-hint">{{ $t('home.uploadDragHint') }}</div>
                </div>
            ...
            <div class="console-divider">
              <span>{{ $t('home.inputParamsLabel') }}</span>
            </div>

            <!-- 输入区域 -->
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">{{ $t('home.simulationPromptLabel') }}</span>
              </div>
              <div class="input-wrapper">
                <textarea
                  v-model="formData.simulationRequirement"
                  class="code-input"
                  :placeholder="$t('home.simulationPlaceholder')"
                  rows="6"
                  :disabled="loading"
                ></textarea>

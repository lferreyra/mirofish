    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a single paragraph of text, <span class="highlight-bold">MiroFish</span> can automatically generate up to<span class="highlight-bold"> 10,000 agents</span> based on its real-world seeds
            </p>
            <p class="slogan-text">
              Let the future be rehearsed among agents, let decisions triumph after a hundred battles<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Supports up to million-scale agent simulation</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relation extraction & profile generation & env config agent simulation parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsing prediction requirements & dynamic temporal memory update</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g. If Wuhan University announces the reversal of the disciplinary action against Xiao, what public opinion trend would emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Uses Space Grotesk as main heading font, JetBrains Mono as code/label font

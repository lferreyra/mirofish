  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class=”hero-section”>
        <div class=”hero-left”>
          <div class=”tag-row”>
            <span class=”orange-tag”>A concise and universal collective intelligence engine</span>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g. What public opinion trends would emerge if a university issued an official statement reversing a disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>

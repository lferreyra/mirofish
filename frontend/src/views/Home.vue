    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a piece of text, <span class=”highlight-bold”>MiroFish</span> can build a parallel world of up to <span class=”highlight-orange”>millions of Agents</span> from the seeds of reality within it. Inject variables from a god's-eye view and find <span class=”highlight-code”>”local optima”</span> in dynamic environments through complex swarm interactions.
            </p>
            <p class=”slogan-text”>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby. Upload multiple unstructured documents to initialize simulation sequences.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any agent in the simulated world & Chat with the ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g. What public opinion trends would emerge if a university revokes a disciplinary decision?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - redirect immediately, API calls happen on the Process page

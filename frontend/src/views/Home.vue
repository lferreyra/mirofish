    ...
    <div class=”main-content”>
      ...
      <section class=”hero-section”>
        <div class=”hero-left”>
          ...
          <div class=”hero-desc”>
            <p>
              Even from a single paragraph, <span class=”highlight-bold”>MiroFish</span> can automatically build a parallel world populated by up to <span class=”highlight-orange”>millions of Agents</span> grounded in real-world seeds. Inject variables from a god's-eye view to discover <span class=”highlight-code”>”local optima”</span> within complex group interactions under dynamic conditions.
            </p>
            <p class=”slogan-text”>
              Let the future unfold inside an Agent swarm — let decisions emerge victorious after a hundred battles<span class=”blinking-cursor”>_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine standing by. Upload one or more unstructured data files to initialize a simulation sequence.
          </p>
          ...
          <div class="steps-container">
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">Knowledge Graph Build</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsed prediction requirements & dynamic temporal memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any participant in the simulated world & converse with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction requirement in natural language (e.g. If Wuhan University announces the revocation of Xiao's disciplinary action, what public opinion trends would emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Space Grotesk is used as the primary heading font, JetBrains Mono for code/labels.

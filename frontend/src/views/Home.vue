  ...
  <div class="home-container">
    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        ...
        <button class="lang-toggle" @click="toggleLang">{{ t('nav.langToggle') }}</button>
      </div>
    </nav>
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p v-if="locale === 'en'">
              Even a single paragraph of text lets <span class="highlight-bold">MiroFish</span> automatically construct a parallel world of up to <span class="highlight-orange">one million Agents</span> from the reality seeds within. Inject variables from a god's-eye view and find the <span class="highlight-code">"local optimum"</span> in dynamic environments through complex group interactions.
            </p>
            <p v-else>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">{{ t('home.highAvailLabel') }}</div>
            </div>
          </div>
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">{{ t('home.consoleSeed') }}</span>
                <span class="console-meta">{{ t('home.consoleFormat') }}</span>
              </div>
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">{{ t('home.consolePrompt') }}</span>
              </div>
            ...
            <div class="console-section btn-section">
              ...
              >
                <span v-if="!loading">{{ t('home.launchBtn') }}</span>
                <span v-else>{{ t('home.launchingBtn') }}</span>
...
import { useLocale, setLocale } from '../store/locale'
...
const toggleLang = () => setLocale(locale.value === 'en' ? 'zh' : 'en')

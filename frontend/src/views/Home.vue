    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even from a single paragraph, <span class=”highlight-bold”>MiroFish</span> can extract reality seeds and automatically generate a parallel world with up to <span class=”highlight-orange”>millions of Agents</span>. Inject variables from a god's-eye view to find <span class=”highlight-code”>”local optima”</span> in complex group interactions under dynamic conditions.
            </p>
            <p class="slogan-text">
              Let the future rehearse among Agents, let decisions prevail after a thousand battles<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Avg. $5 per simulation run</div>
            </div>
            <div class="metric-card">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relationship extraction & persona generation & environment config with Agent simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent leverages a rich toolset to deeply interact with the post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirements in natural language (e.g., What would happen to public opinion if a university reversed a disciplinary decision?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Space Grotesk as the main heading font, JetBrains Mono as code/label font

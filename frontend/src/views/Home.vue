    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        ...
        <a href="https://github.com/666ghj/MiroFish" target="_blank" class="github-link">
          {{ $t('nav.githubLink') }} <span class="arrow">↗</span>
        </a>
      </div>
    </nav>
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              {{ $t('home.descPart1') }}<span class="highlight-bold">{{ $t('home.descBold') }}</span>{{ $t('home.descPart2') }}<span class="highlight-orange">{{ $t('home.descOrange') }}</span>{{ $t('home.descPart3') }}<span class="highlight-code">{{ $t('home.descCode') }}</span>{{ $t('home.descPart4') }}
            </p>
            <p class="slogan-text">
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">{{ $t('home.consoleSeeds') }}</span>
            ...
            <div class="console-section btn-section">
              ...
              >
                ...
                <span v-else>{{ $t('home.startEngineLoading') }}</span>

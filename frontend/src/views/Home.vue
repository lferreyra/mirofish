  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">{{ $t('home.heroTag') }}</span>
            <span class="version-text">{{ $t('home.versionPreview') }}</span>
          </div>
...
const heroDescHtml = computed(() => {
  const name = 'MiroFish'
  const count = t('home.heroCount')
  const term = t('home.heroTerm')
  const raw = t('home.heroDesc', { name, count, term })
  return raw
    .replace(name, `<span class="highlight-bold">${name}</span>`)
    .replace(count, `<span class="highlight-orange">${count}</span>`)
    .replace(term, `<span class="highlight-code">${term}</span>`)
})

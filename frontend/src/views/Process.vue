<template>
  <div class="process-page">
    ...
    <div class="main-content">
      <!-- Left panel: real-time knowledge graph -->
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes their content and automatically generates an ontology structure suitable for opinion simulation (entity types + relation types).
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Using the generated ontology, documents are chunked and the Zep API is called to build the knowledge graph, extracting entities and relations.
                </div>
              </div>
...
const initProject = async () => {
  ...
  if (paramProjectId === 'new') {
    // New project: fetch pending upload data from store
...
const renderGraph = () => {
  ...
  // Draw edges (includes a transparent wide clickable line)
  ...
  simulation.on('tick', () => {
    // Update all edge positions (visible line and transparent click area)

      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph build will start after ontology is ready</p>
          </div>
      ...
      <div class="right-panel" :class="{ 'hidden': isFullScreen }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After upload, the LLM analyzes content and generates an ontology for discourse simulation (entity + relation types).
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API</div>
                <div class="detail-content">
                  Using the ontology, documents are chunked and sent to Zep to build the graph—entities and relations.
                </div>
              </div>
        ...
        <div class="project-panel">
          ...
          <div class="project-details" v-if="projectData">
            ...
            <div class="project-item">
              <span class="item-label">Simulation prompt</span>
...
const goToNextStep = () => {
  // TODO: 进入环境搭建步骤
  alert('Environment setup is not wired from this page yet.')
}

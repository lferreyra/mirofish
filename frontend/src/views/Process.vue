      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph building will start automatically once ontology generation finishes</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After the documents are uploaded, the LLM analyzes the content and generates an ontology tailored for public-opinion simulation with entity types and relation types.
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Endpoint</div>
                <div class="detail-content">
                  Using the generated ontology, the documents are chunked and sent to the Zep API to build the knowledge graph and extract entities and relationships.
                </div>
              </div>
...
const goToNextStep = () => {
  // TODO: 进入环境搭建步骤
  alert('Environment setup is still in development...')
}
...
const handleNewProject = async () => {
  ...
  try {
    ...
    if (response.success) {
      ...
      error.value = response.error || 'Failed to generate ontology'
    }
  } catch (err) {

    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          <!-- Graph visualization (displayed when data exists) -->
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, LLM analyzes the document content and automatically generates an ontology structure suitable for opinion simulation (entity types + relation types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, chunk the documents and call Zep API to build the knowledge graph, extracting entities and relations
                </div>
              </div>
...
const currentPhase = ref(-1) // -1: Upload, 0: Ontology generation, 1: Graph build, 2: Complete
...
const renderGraph = () => {
  ...
  simulation.on('tick', () => {
    // Update all edge positions (including visible line and transparent click area)

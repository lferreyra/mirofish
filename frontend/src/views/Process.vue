      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          <div class="header-left">
            ...
            <span class="header-title">{{ t('process.graphTitle') }}</span>
          </div>
          <div class="header-right">
            ...
            <div class="action-buttons">
                <button class="action-btn" @click="refreshGraph" :disabled="graphLoading" :title="t('process.refreshTitle')">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, LLM analyzes content and auto-generates an ontology structure (entity types + relation types) suitable for opinion simulation.
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, documents are chunked and fed to the Zep API to build a knowledge graph, extracting entities and relations.
                </div>
              </div>
...
const getPhaseStatusText = (phase) => {
  if (currentPhase.value > phase) return t.value('step1.completed')

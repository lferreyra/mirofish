<template>
  <div class="process-page">
    <!-- Top Navigation Bar -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">ARUS</div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes content and auto-generates an ontology structure for opinion simulation (entity types + relation types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on generated ontology, chunks documents and calls Zep API to build knowledge graph, extracting entities and relations
                </div>
              </div>
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No files pending upload. Please go back and try again.'
    loading.value = false
    return
  }
...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Continue polling in-progress build tasks
...
const renderGraph = () => {
  ...
  // Draw edges (includes clickable transparent wide lines)

      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph building will start automatically after ontology generation completes.</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After you upload documents, the LLM analyzes the content and automatically generates an ontology structure suitable for opinion simulation (entity types + relation types).
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Using the generated ontology, the system chunks the documents and calls the Zep API to build a knowledge graph and extract entities and relations.
                </div>
              </div>
...
const currentPhase = ref(-1) // -1: 上传中, 0: Generating Ontology, 1: Graph Build, 2: 完成
const selectedItem = ref(null) // 选中的nodesor边
...
const goToNextStep = () => {
  // TODO: Enter Environment Setup步骤
...
const handleNewProject = async () => {
  ...
  try {
    ...
    formDataObj.append('input_parse_mode', pending.inputParseMode || 'text_only')
...
const startBuildGraph = async () => {
  try {
    ...
    if (response.success) {
      ...
      // 保存 task_id 用于rounds询
      const taskId = response.data.task_id
      
      // 启动Graph数据rounds询（独立于任务状态rounds询）
      startGraphPolling()

            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, LLM analyzes the content and automatically generates an ontology structure (entity types + relation types) suitable for opinion simulation.
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, the documents are chunked and Graphiti + Neo4j is used to build the knowledge graph, extracting entities and relationships.
                </div>
              </div>
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending files found. Please go back to the home page and try again.'
    loading.value = false
    return
  }
...
const renderGraph = () => {
  ...
  // Click on blank space to close detail panel
  svg.on('click', () => {
    closeDetailPanel()
  })
  
  simulation.on('tick', () => {
    // Update all edge positions (visible lines and transparent click areas)

          ...
          >
            ...
            <div class="timeline-card">
              ...
              <div class="card-body">
                ...
                <!-- General Fallback: Unknown type or has content but not handled above -->
...
const actionIds = ref(new Set()) // Set for deduplication of action IDs
...
// Format elapsed simulation time (calculated from round count and minutes per round)
...
const doStartSimulation = async () => {
  ...
  // Reset all state first to ensure no influence from previous simulation
  resetAllState()

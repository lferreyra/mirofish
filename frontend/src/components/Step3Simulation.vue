...
// Track each platform's last round, for detecting changes and outputting logs
...
const checkPlatformsCompleted = (data) => {
  // If no platform data at all, return false
...
const fetchRunStatusDetail = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Don't auto-scroll, let user browse timeline freely

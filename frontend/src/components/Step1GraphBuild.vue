      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('process.ontologyPhase') }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('process.graphBuildPhase') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">{{ $t('process.relationEdges') }}</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ graphStats.types }}</span>
              <span class="stat-label">{{ $t('process.entityTypes') }}</span>
            </div>
          </div>
        </div>
      </div>

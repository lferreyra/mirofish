        ...
        <div class="card-content">
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">{{ $t('step1.edges') }}</span>
            </div>
            <div class="stat-card">
...
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error(t('step1.missingInfo'))
    return
  }
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      console.error(t('step1.createSimFailed'), res.error)
      alert(t('step1.createSimFailed') + (res.error || t('common.unknownError')))
    }
  } catch (err) {
    console.error(t('step1.createSimError'), err)

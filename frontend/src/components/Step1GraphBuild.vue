      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step1.ontologyTitle') }}</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('step1.ontologyDescription') }}</p>

          <!-- Loading / Progress -->
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            <div class="spinner-sm"></div>
            <span>{{ ontologyProgress.message || t('step1.ontologyProgressFallback') }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step1.graphBuildTitle') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('step1.graphBuildDescription') }}</p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step1.buildCompleteTitle') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('step1.buildCompleteDescription') }}</p>
          <button 
            class="action-btn" 
...
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error(t('step1.missingProjectInfo'))
    return
  }
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      console.error(t('step1.createSimulationFailed'), res.error)
      alert(`${t('step1.createSimulationFailed')} ${res.error || t('common.unknownError')}`)
    }
  } catch (err) {
    console.error(t('step1.createSimulationError'), err)
    alert(`${t('step1.createSimulationError')} ${err.message}`)
  } finally {

  ...
  <div class="graph-panel">
    <div class="panel-header">
      ...
      <div class="header-tools">
        ...
        <button class="tool-btn" @click="$emit('toggle-maximize')" :title="$t('graph.maximizeTooltip')">
    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? $t('graph.graphRAGUpdating') : $t('graph.realtimeUpdating') }}
        </div>
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">{{ $t('graph.postSimHint') }}</span>
          ...
          <div v-else class="detail-content">
            ...
            <template v-if="selectedItem.data.isSelfLoopGroup">
              <div class="edge-relation-header self-loop-header">
                ...
                <span class="self-loop-count">{{ $t('graph.selfRelationsItems', { count: selectedItem.data.selfLoopCount }) }}</span>
              </div>

          ...
          <div v-else class="detail-content">
            ...
            <template v-if="selectedItem.data.isSelfLoopGroup">
              <div class="edge-relation-header self-loop-header">
                {{ $t('graph.selfRelations', { name: selectedItem.data.source_name }) }}
            ...
            <template v-else>
              <div class="edge-relation-header">
                {{ selectedItem.data.source_name }} → {{ selectedItem.data.name || $t('graph.related') }} → {{ selectedItem.data.target_name }}
              </div>
              ...
              <div class="detail-row">
                <span class="detail-label">{{ $t('graph.label') }}:</span>
                <span class="detail-value">{{ selectedItem.data.name || $t('graph.related') }}</span>
              </div>
              <div class="detail-row">
                <span class="detail-label">{{ $t('graph.type') }}:</span>
                <span class="detail-value">{{ selectedItem.data.fact_type || $t('common.unknown') }}</span>
              </div>

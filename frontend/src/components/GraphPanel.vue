  ...
  <div class="graph-panel">
    <div class="panel-header">
      ...
      <div class="header-tools">
        <button class="tool-btn" @click="$emit('refresh')" :disabled="loading" :title="t('process.refresh')">
    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? t('graphPanel.memoryUpdate') : t('graphPanel.realtimeUpdate') }}
        </div>
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">{{ t('graphPanel.pendingProcessing') }}</span>
        ...
        <div v-if="selectedItem" class="detail-panel">
            ...
            <div class="detail-section" v-if="selectedItem.data.attributes && Object.keys(selectedItem.data.attributes).length > 0">
              ...
              <div class="properties-list">
                <div v-for="(value, key) in selectedItem.data.attributes" :key="key" class="property-item">
                  ...
                  <span class="property-value">{{ value || t('graphPanel.none') }}</span>
                </div>
              </div>
            </div>
          ...
          <div v-else class="detail-content">
            ...
            <template v-else>
              ...
              <div class="detail-row">
                <span class="detail-label">{{ t('graphPanel.type') }}</span>
                <span class="detail-value">{{ selectedItem.data.fact_type || t('graphPanel.none') }}</span>
              </div>
      ...
      <div v-else class="graph-state">
        ...
        <p class="empty-text">{{ t('process.waiting') }}</p>
      </div>
    </div>

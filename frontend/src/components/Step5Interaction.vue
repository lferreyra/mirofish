            ...
            >
              ...
              <div class="section-body" v-show="!collapsedSections.has(idx)">
                ...
                <div v-else-if="currentSectionIndex === idx + 1" class="loading-state">
                  ...
                  <span class="loading-text">{{ $t('step5.generating', { title: section.title }) }}</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || $t('step5.unknownJob') }}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('step5.tools.insightForge') }}</div>
                    <div class="tool-desc">{{ $t('step5.tools.insightForgeDesc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('step5.tools.panoramaSearch') }}</div>
                    <div class="tool-desc">{{ $t('step5.tools.panoramaSearchDesc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('step5.tools.quickSearch') }}</div>
                    <div class="tool-desc">{{ $t('step5.tools.quickSearchDesc') }}</div>
                  </div>
                </div>
            ...
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || $t('step5.unknownJob') }}</span>
                </div>
              </div>

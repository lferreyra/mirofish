      ...
      <div class="right-panel" ref="rightPanel">
        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-text">
            ...
            <span class="action-bar-subtitle mono">{{ $t('step5.agentsAvailable', { n: profiles.length }) }}</span>
          </div>
        </div>
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : $t('step5.chatWithAnyone') }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">{{ $t('step5.pickChatTarget') }}</div>
                <div 
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || $t('common.unknownProfession') }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                <div class="tools-card-name">{{ $t('step5.reportAgentCard') }}</div>
                <div class="tools-card-subtitle">{{ $t('step5.reportAgentSub') }}</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('step5.toolInsight') }}</div>
                    <div class="tool-desc">{{ $t('step5.toolInsightDesc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('step5.toolPanorama') }}</div>
                    <div class="tool-desc">{{ $t('step5.toolPanoramaDesc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('step5.toolQuick') }}</div>
                    <div class="tool-desc">{{ $t('step5.toolQuickDesc') }}</div>
                  </div>
                </div>
            ...
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || $t('common.unknownProfession') }}</span>
                </div>
              </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? $t('step5.chatReportHint') : $t('step5.chatAgentHint') }}
              </p>
            </div>
            <div 
          ...
          <div class="chat-input-area">
            <textarea 
              v-model="chatInput"
              class="chat-input"
              :placeholder="$t('step5.placeholderAsk')"
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                ...
                <span class="selection-count">{{ $t('step5.selectionCount', { selected: selectedAgents.size, total: profiles.length }) }}</span>
              </div>
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || $t('common.unknownProfession') }}</span>
                  </div>
            ...
            >
              ...
              <span v-if="isSurveying">{{ $t('step5.sendingSurvey') }}</span>
              <span v-else>{{ $t('step5.sendSurvey') }}</span>
            </button>
          </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              ...
              <span class="results-count">{{ $t('step5.resultsCount', { n: surveyResults.length }) }}</span>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || $t('common.unknownProfession') }}</span>
                  </div>
                </div>

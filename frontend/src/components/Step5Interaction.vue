          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">{{ $t('step5.bioLabel') }}</div>
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">{{ $t('step5.surveySelectTargets') }}</span>
                <span class="selection-count">{{ $t('step5.surveySelected', { selected: selectedAgents.size, total: profiles.length }) }}</span>
              </div>
              ...
              <div class="selection-actions">
                <button class="action-link" @click="selectAllAgents">{{ $t('step5.surveySelectAll') }}</button>
                <span class="action-divider">|</span>
                <button class="action-link" @click="clearAgentSelection">{{ $t('step5.surveyClear') }}</button>
              </div>
            </div>
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                :placeholder="$t('step5.surveyQuestionPlaceholder')"
                rows="3"
              ></textarea>
            </div>
            ...
            >
              ...
              <span v-else>{{ $t('step5.surveySend') }}</span>
            </button>
          </div>

        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>{{ $t('step5.tabReportAgent') }}</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : $t('step5.tabAgent') }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">{{ $t('step5.selectAgent') }}</div>
                <div 
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">{{ $t('step5.toolsCardSubtitle') }}</div>
              </div>
            ...
            <div v-if="showToolsDetail" class="tools-card-body">
              <div class="tools-grid">
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('step5.toolInterviewAgent') }}</div>
                    <div class="tool-desc">{{ $t('step5.toolInterviewAgentDesc') }}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">{{ $t('step5.profileLabel') }}</div>
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">{{ $t('step5.surveySelectTitle') }}</span>
                <span class="selection-count">{{ $t('step5.surveySelected', { n: selectedAgents.size, total: profiles.length }) }}</span>
              </div>
              ...
              <div class="selection-actions">
                <button class="action-link" @click="selectAllAgents">{{ $t('common.selectAll') }}</button>
                <span class="action-divider">|</span>
                <button class="action-link" @click="clearAgentSelection">{{ $t('common.clear') }}</button>
              </div>
            </div>

            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">{{ $t('step5.surveyQuestionTitle') }}</span>
              </div>
              <textarea 
            ...
            >
              ...
              <span v-else>{{ $t('step5.surveySubmit') }}</span>
            </button>
          </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              ...
              <span class="results-count">{{ $t('step5.surveyResultsCount', { n: surveyResults.length }) }}</span>
            </div>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`${t('step5.selectAgent')}: ${agent.username}`)
}
...
// Lifecycle
onMounted(() => {
  addLog(t('views.viewInit', { view: 'Step5' }))
  loadReportData()
  loadProfiles()

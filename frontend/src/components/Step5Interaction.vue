          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A quick-chat version of the report generation agent, with access to 4 professional tools and MiroFish's full memory</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface with optimized indexing for rapid extraction of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that can conduct parallel multi-round conversations with agents in the simulation world, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>

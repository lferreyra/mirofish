        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Dialoga con Report Agent</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Dialoga con qualsiasi individuo nel mondo' }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Seleziona interlocutore</div>
                <div 
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || 'Professione sconosciuta' }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>Invia sondaggio nel mondo</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Versione chat rapida dell'agente di generazione report, con accesso a 4 strumenti professionali e alla memoria completa di MiroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InsightForge Attribuzione Approfondita</div>
                    <div class="tool-desc">Allinea i dati seed del mondo reale con lo stato dell'ambiente simulato, combina meccanismi di memoria Global/Local per fornire analisi di attribuzione approfondita cross-temporale</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch Tracciamento Panoramico</div>
                    <div class="tool-desc">Algoritmo di attraversamento in ampiezza basato su struttura a grafo, ricostruisce i percorsi di propagazione degli eventi, cattura la topologia completa del flusso informativo</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">QuickSearch Ricerca Rapida</div>
                    <div class="tool-desc">Interfaccia di query istantanea basata su GraphRAG, ottimizza l'efficienza dell'indicizzazione per estrarre rapidamente attributi specifici dei nodi e fatti discreti</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InterviewSubAgent Intervista Virtuale</div>
                    <div class="tool-desc">Intervista autonoma, in grado di condurre dialoghi paralleli a piu' turni con gli individui nel mondo simulato, raccogliendo dati di opinione non strutturati e stati psicologici</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || 'Professione sconosciuta' }}</span>
                </div>
              </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Dialoga con Report Agent per approfondire il contenuto del report' : 'Dialoga con gli individui simulati per conoscere le loro opinioni' }}
              </p>
            </div>
            <div 
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Seleziona destinatari sondaggio</span>
                <span class="selection-count">Selezionati {{ selectedAgents.size }} / {{ profiles.length }}</span>
              </div>
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || 'Professione sconosciuta' }}</span>
                  </div>
              ...
              <div class="selection-actions">
                <button class="action-link" @click="selectAllAgents">Seleziona tutto</button>
                <span class="action-divider">|</span>
                <button class="action-link" @click="clearAgentSelection">Svuota</button>
              </div>
            </div>

            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Domande del sondaggio</span>
              </div>
              <textarea 
                v-model="surveyQuestion"
                class="survey-input"
                placeholder="Inserisci la domanda da rivolgere a tutti i destinatari selezionati..."
                rows="3"
              ></textarea>
            </div>
            ...
            >
              ...
              <span v-else>Invia sondaggio</span>
            </button>
          </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              <span class="results-title">Risultati sondaggio</span>
              <span class="results-count">{{ surveyResults.length }} risposte</span>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || 'Professione sconosciuta' }}</span>
                  </div>
                </div>
...
const chatHistoryCache = ref({}) // Cache di tutte le conversazioni: { 'report_agent': [], 'agent_0': [], 'agent_1': [], ... }
...
// Salva la conversazione corrente nella cache
...
const selectReportAgentChat = () => {
  ...
  // Ripristina la conversazione di Report Agent
...
const selectAgent = (agent, idx) => {
  ...
  // Ripristina la conversazione di questo Agent
  chatHistory.value = chatHistoryCache.value[`agent_${idx}`] || []
  addLog(`Interlocutore selezionato: ${agent.username}`)
}
...
const sendMessage = async () => {
  ...
  try {
    ...
    addLog(`Invio fallito: ${err.message}`)
    chatHistory.value.push({
      role: 'assistant',
      content: `Spiacente, si e' verificato un errore: ${err.message}`,
      timestamp: new Date().toISOString()
    })
  } finally {
    isSending.value = false
    scrollToBottom()
    // Salva automaticamente la conversazione nella cache
    saveChatHistory()
  }
}

const sendToReportAgent = async (message) => {
  addLog(`Inviato a Report Agent: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    chatHistory.value.push({
      role: 'assistant',
      content: res.data.response || res.data.answer || 'Nessuna risposta',
      timestamp: new Date().toISOString()
    })
    addLog('Report Agent ha risposto')
  } else {
    throw new Error(res.error || 'Richiesta fallita')
  }
}

const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Seleziona prima un individuo simulato')
  }
  
  addLog(`Inviato a ${selectedAgent.value.username}: ${message.substring(0, 50)}...`)
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? 'Intervistatore' : 'Tu'}：${msg.content}`)
      .join('\n')
    prompt = `Ecco la nostra conversazione precedente:\n${historyContext}\n\nLa mia nuova domanda e':\n${message}`
  }
  ...
  if (res.success && res.data) {
    // Percorso dati corretto: res.data.result.results e' un dizionario oggetto
    // Formato: {"twitter_0": {...}, "reddit_0": {...}} o singola piattaforma {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData

    // Converti il dizionario in array, priorita' alle risposte dalla piattaforma reddit
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Priorita' alla risposta reddit, poi twitter
    ...
    if (responseContent) {
      ...
      addLog(`${selectedAgent.value.username} ha risposto`)
    } else {
      throw new Error('Nessun dato di risposta')
    }
  } else {
    throw new Error(res.error || 'Richiesta fallita')
  }
...
const submitSurvey = async () => {
  ...
  addLog(`Invio sondaggio a ${selectedAgents.value.size} destinatari...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Converti il dizionario in formato array
      ...
      for (const interview of interviews) {
        ...
        // Priorita' alla risposta reddit, poi twitter
        let responseContent = 'Nessuna risposta'
        ...
        if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
          ...
          if (agentResult) {
            responseContent = agentResult.response || agentResult.answer || 'Nessuna risposta'
          }
        } else if (Array.isArray(resultsDict)) {
          // Compatibile con formato array
          const matchedResult = resultsDict.find(r => r.agent_id === agentIdx)
          if (matchedResult) {
            responseContent = matchedResult.response || matchedResult.answer || 'Nessuna risposta'
          }
        }
      ...
      addLog(`Ricevute ${surveyResults.value.length} risposte`)
    } else {
      throw new Error(res.error || 'Richiesta fallita')
    }
  } catch (err) {
    addLog(`Invio sondaggio fallito: ${err.message}`)
  } finally {
...
const loadReportData = async () => {
  ...
  try {
    addLog(`Caricamento dati report: ${props.reportId}`)
    ...
    addLog(`Caricamento report fallito: ${err.message}`)
  }
}
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog('Caricamento dati report completato')
    }
  } catch (err) {
    addLog(`Caricamento log report fallito: ${err.message}`)
  }
}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Caricati ${profiles.value.length} individui simulati`)
    }
  } catch (err) {
    addLog(`Caricamento individui simulati fallito: ${err.message}`)
  }
}
...
// Lifecycle
onMounted(() => {
  addLog('Step5 Inizializzazione Interazione Approfondita')
  loadReportData()
  loadProfiles()
...
/* Left Panel - Report Style (Identico a Step4Report.vue) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* Correggi numerazione liste ordinate - usa contatori CSS per numerazione continua tra piu' ol */
.message-text {
...
/* Stili citazione per area chat/sondaggio */

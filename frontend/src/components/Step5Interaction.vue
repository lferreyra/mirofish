          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Chat with any simulated participant' }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Select a participant</div>
                <div 
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast conversational mode for the report agent, with 4 specialist tools and full MiroFish memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InsightForge Causal Analysis</div>
                    <div class="tool-desc">Aligns real-world seed data with simulation state and combines global and local memory for deeper cross-temporal causal analysis.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch Full-Path Tracking</div>
                    <div class="tool-desc">Uses graph traversal to reconstruct event propagation paths and capture the topology of information flow.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">A GraphRAG-based instant query interface optimized for fast extraction of node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InterviewSubAgent Virtual Interviews</div>
                    <div class="tool-desc">Conducts parallel multi-turn interviews with simulated participants to collect unstructured views and psychological state.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to dig deeper into the report' : 'Chat with a simulated participant to understand their perspective' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Type the question you want to ask all selected participants..."
                rows="3"
              ></textarea>
            </div>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Selected participant: ${agent.username}`)
}
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Select a simulated participant first')
  }
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .join('\n')
    prompt = `Here is our earlier conversation:\n${historyContext}\n\nMy new question is: ${message}`
  }
...
const submitSurvey = async () => {
  ...
  addLog(`Sending survey to ${selectedAgents.value.size} participants...`)
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Loaded ${profiles.value.length} simulated participants`)
    }
  } catch (err) {
    addLog(`Failed to load simulated participants: ${err.message}`)
  }
}

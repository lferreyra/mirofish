                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="special-icon">
                  ...
                  <defs>
                    <linearGradient id="paint0_linear" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse">
                      <stop stop-color="hsl(217, 75%, 47%)"/>
                      <stop offset="1" stop-color="hsl(213, 75%, 60%)"/>
                    </linearGradient>
                  </defs>
                </svg>
...
.badge.success { background: var(--secondary); color: var(--accent); }
.badge.processing { background: var(--primary); color: var(--primary-foreground); }
.badge.pending { background: var(--secondary); color: var(--muted-foreground); }
.badge.accent { background: var(--secondary); color: var(--accent); }

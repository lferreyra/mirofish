    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create a simulation instance and load the world-parameter template.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using context, tools pull entities and relations from the graph, initialize agents, and seed unique behavior and memory from real-world seeds.
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Topics linked to seeds</span>
            </div>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM sets world clock speed, feed algorithms, per-agent active hours, posting rates, triggers, and more from your goal and seeds.
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                <div class="config-item">
                  <span class="config-item-label">Simulated duration</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Recommendation weights</span>
              </div>
            ...
            <div v-if="simulationConfig.generation_reasoning" class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">LLM rationale</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            From the narrative direction, generate seed events and hot topics to set the world’s starting state.
          </p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish plans <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> h of real time; each round advances <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> min of that timeline</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>At ~100 agents: est. {{ Math.round(customMaxRounds * 0.6) }} min</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        At ~100 agents: est. {{ Math.round(autoGeneratedRounds * 0.6) }} min
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">First run? Switch to custom mode and reduce rounds for a quicker preview and fewer errors ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Stated age (event)</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} yrs</span>
            </div>
            <div class="info-item">
              <span class="info-label">Stated gender (event)</span>
            ...
            <div class="info-item">
              <span class="info-label">Stated MBTI (event)</span>
          ...
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">Topics linked to seeds</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">Event narrative arc</span>
                <span class="dim-desc">Full behavior trace in this event</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behavioral profile</span>
                <span class="dim-desc">Style patterns and preferences</span>
              </div>
              <div class="dimension-card">
              ...
              <div class="dimension-card">
                <span class="dim-title">Social graph</span>
                <span class="dim-desc">Ties and interaction map</span>
              </div>
            </div>
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Preparation already complete; skipping')
    ...
    if (res.success && res.data) {
      ...
      if (data.generation_stage && data.generation_stage !== lastLoggedConfigStage) {
        ...
        if (data.generation_stage === 'generating_profiles') {
          ...
          addLog('Calling LLM for simulation parameters...')
        }
      }
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          ...
          addLog(`  ├─ Sim hours: ${data.summary.simulation_hours}`)
        ...
        stopConfigPolling()
        phase.value = 4
        addLog('✓ Environment ready; you can start the simulation')
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        if (res.data.summary) {
          ...
          addLog(`  ├─ Sim hours: ${res.data.summary.simulation_hours}`)

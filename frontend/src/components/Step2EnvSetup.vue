  ...
  <div class="env-setup-panel">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.s01Title') }}</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 0" class="badge success">{{ $t('step2.badgeDone') }}</span>
            <span v-else class="badge processing">{{ $t('step2.badgeInit') }}</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div v-if="simulationId" class="info-card">
            <div class="info-row">
              <span class="info-label">{{ $t('step2.labelProjectId') }}</span>
              <span class="info-value mono">{{ projectData?.project_id }}</span>
            </div>
            <div class="info-row">
              <span class="info-label">{{ $t('step2.labelGraphId') }}</span>
              <span class="info-value mono">{{ projectData?.graph_id }}</span>
            </div>
            <div class="info-row">
              <span class="info-label">{{ $t('step2.labelSimulationId') }}</span>
              <span class="info-value mono">{{ simulationId }}</span>
            </div>
            <div class="info-row">
              <span class="info-label">{{ $t('step2.labelTaskId') }}</span>
              <span class="info-value mono">{{ taskId || $t('step2.taskAsyncDone') }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.s02Title') }}</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 1" class="badge success">{{ $t('step2.badgeDone') }}</span>
            <span v-else-if="phase === 1" class="badge processing">{{ prepareProgress }}%</span>
            <span v-else class="badge pending">{{ $t('step2.badgeWait') }}</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">{{ $t('step2.statAgents') }}</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ expectedTotal || '-' }}</span>
              <span class="stat-label">{{ $t('step2.statExpectedAgents') }}</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ totalTopicsCount }}</span>
              <span class="stat-label">{{ $t('step2.statTopics') }}</span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">{{ $t('step2.profilesPreview') }}</span>
            </div>
            <div class="profiles-list">
              ...
              >
                ...
                <div class="profile-meta">
                  <span class="profile-profession">{{ profile.profession || $t('common.unknownProfession') }}</span>
                </div>
                <p class="profile-bio">{{ profile.bio || $t('common.noBio') }}</p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.s03Title') }}</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 2" class="badge success">{{ $t('step2.badgeDone') }}</span>
            <span v-else-if="phase === 2" class="badge processing">{{ $t('step2.badgeGen') }}</span>
            <span v-else class="badge pending">{{ $t('step2.badgeWait') }}</span>
          </div>
        </div>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">{{ $t('step2.configAgentsPerHour') }}</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                ...
                <span class="config-block-badge">{{ $t('step2.agentConfigCount', { n: simulationConfig.agent_configs?.length || 0 }) }}</span>
              </div>
                ...
                >
                  ...
                  <div class="agent-card-header">
                    <div class="agent-identity">
                      <span class="agent-id">{{ $t('step2.agentLabel', { id: agent.agent_id }) }}</span>
                  ...
                  <div class="agent-params">
                    ...
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">{{ $t('step2.activity') }}</span>
                      ...
                      <div class="param-item">
                        <span class="param-label">{{ $t('step2.sentiment') }}</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ $t('step2.recAlgo') }}</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  ...
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">{{ $t('step2.weightRecency') }}</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.recency_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">{{ $t('step2.weightPopularity') }}</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.popularity_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">{{ $t('step2.weightRelevance') }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.s04Title') }}</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 3" class="badge success">{{ $t('step2.badgeDone') }}</span>
            <span v-else-if="phase === 3" class="badge processing">{{ $t('step2.badgeOrch') }}</span>
            <span v-else class="badge pending">{{ $t('step2.badgeWait') }}</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="initial-posts-section">
              <span class="box-label">{{ $t('step2.initialPosts', { n: simulationConfig.event_config.initial_posts.length }) }}</span>
                  ...
                  <div class="timeline-content">
                    <div class="post-header">
                      ...
                      <span class="post-agent-info">
                        <span class="post-id">{{ $t('step2.agentLabel', { id: post.poster_agent_id }) }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.s05Title') }}</span>
          </div>
          <div class="step-status">
            <span v-if="phase >= 4" class="badge processing">{{ $t('step2.badgeInProgress') }}</span>
            <span v-else class="badge pending">{{ $t('step2.badgeWait') }}</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <p class="description">{{ $t('step2.descS05') }}</p>
          
          <!-- 模拟轮数配置 - 只有在配置生成完成且轮数计算出来后才显示 -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">{{ $t('step2.roundsTitle') }}</span>
                <span class="section-desc">{{ $t('step2.roundsDescLine1') }}<span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span>{{ $t('step2.roundsDescLine2') }}<span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span>{{ $t('step2.roundsDescLine3') }}</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>{{ $t('step2.estTimeHint', { minutes: Math.round(customMaxRounds * 0.6) }) }}</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        {{ $t('step2.estTimeHintAuto', { minutes: Math.round(autoGeneratedRounds * 0.6) }) }}
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">{{ $t('step2.tipFirstRun') }} ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">{{ $t('step2.modalAge') }}</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} {{ $t('step2.yearsOld') }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ $t('step2.modalGender') }}</span>
              <span class="info-value">{{ { male: $t('common.male'), female: $t('common.female'), other: $t('common.other') }[selectedProfile.gender] || selectedProfile.gender }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ $t('step2.modalCountry') }}</span>
              <span class="info-value">{{ selectedProfile.country || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ $t('step2.modalMbti') }}</span>
          ...
          <div class="modal-section">
            ...
            <p class="section-bio">{{ selectedProfile.bio || $t('common.noBio') }}</p>
          </div>

          <!-- 关注话题 -->
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">{{ $t('step2.seedTopics') }}</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">{{ $t('step2.personaDetail') }}</span>
            
            <!-- 人设维度概览 -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">{{ $t('step2.dim1Title') }}</span>
                <span class="dim-desc">{{ $t('step2.dim1Desc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ $t('step2.dim2Title') }}</span>
                <span class="dim-desc">{{ $t('step2.dim2Desc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ $t('step2.dim3Title') }}</span>
                <span class="dim-desc">{{ $t('step2.dim3Desc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ $t('step2.dim4Title') }}</span>
                <span class="dim-desc">{{ $t('step2.dim4Desc') }}</span>
              </div>
            </div>
    ...
    <div class="system-logs">
      <div class="log-header">
        <span class="log-title">{{ $t('common.systemDashboard') }}</span>
        <span class="log-id">{{ simulationId || $t('common.noSimulation') }}</span>
      </div>

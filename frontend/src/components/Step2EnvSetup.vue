    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.instanceTitle') }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.personaTitle') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">{{ t('step2.topicsCount') }}</span>
            </div>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently sets world time flow, recommendation algorithms, each individual's active hours, posting frequency, event triggers, and other parameters based on simulation requirements and reality seeds.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Based on the narrative direction, auto-generate initial activation events and trending topics to guide the initial state of the simulated world.
          </p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish auto-plans <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> real-world hours; each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of real-world time</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>Est. ~{{ Math.round(customMaxRounds * 0.6) }} min for 100 agents</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        Est. ~{{ Math.round(autoGeneratedRounds * 0.6) }} min for 100 agents
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">First time running? We strongly recommend switching to Custom Mode to reduce rounds for a quick preview and lower error risk. ➝</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            ...
            <div class="info-item">
              ...
              <span class="info-value">{{ selectedProfile.gender }}</span>
            </div>
            <div class="info-item">
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">{{ t('step2.personaBackground') }}</span>

            <!-- Persona dimension overview -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.dimEventHistory') }}</span>
                <span class="dim-desc">{{ t('step2.dimEventHistoryDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.dimBehaviorPattern') }}</span>
                <span class="dim-desc">{{ t('step2.dimBehaviorPatternDesc') }}</span>
              </div>
              <div class="dimension-card">

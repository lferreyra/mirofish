<template>
  <div class="env-setup-panel">
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.step1Title') }}</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('step2.step1Description') }}</p>
          ...
          <div v-if="simulationId" class="info-card">
            ...
            <div class="info-row">
              ...
              <span class="info-value mono">{{ taskId || t('step2.asyncTaskComplete') }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.step2Title') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('step2.step2Description') }}</p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">{{ t('step2.topicCount') }}</span>
            </div>
          </div>
      ...
      <!-- Step 03: Dual-Platform Config -->
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">03</span>
            <span class="step-title">{{ t('step2.step3Title') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">{{ t('step2.step3Description') }}</p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                <div class="config-item">
                  <span class="config-item-label">{{ t('step2.totalSimulationHours') }}</span>
                  <span class="config-item-value">{{ simulationConfig.time_config?.total_simulation_hours || '-' }} {{ t('step2.hoursUnit') }}</span>
                </div>
                <div class="config-item">
                  <span class="config-item-label">{{ t('step2.perRoundDuration') }}</span>
                  <span class="config-item-value">{{ simulationConfig.time_config?.minutes_per_round || '-' }} {{ t('step2.minutesUnit') }}</span>
                </div>
                <div class="config-item">
                  <span class="config-item-label">{{ t('step2.totalRounds') }}</span>
                  <span class="config-item-value">{{ Math.floor((simulationConfig.time_config?.total_simulation_hours * 60 / simulationConfig.time_config?.minutes_per_round)) || '-' }} {{ t('step2.roundsUnit') }}</span>
                </div>
                <div class="config-item">
            ...
            <div class="config-block">
              <div class="config-block-header">
                ...
                <span class="config-block-badge">{{ simulationConfig.agent_configs?.length || 0 }} {{ t('step2.countSuffix') }}</span>
              </div>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ t('step2.recommendationConfig') }}</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.step4Title') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">{{ t('step2.step4Description') }}</p>
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="initial-posts-section">
              <span class="box-label">{{ t('step2.initialSequence', { count: simulationConfig.event_config.initial_posts.length }) }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.step5Title') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('step2.step5Description') }}</p>
          
          <!-- 模拟轮数配置 - 只有在配置生成完成且轮数计算出来后才显示 -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">{{ t('step2.roundsConfigTitle') }}</span>
                <span class="section-desc">{{ t('step2.roundsConfigDesc', { hours: simulationConfig?.time_config?.total_simulation_hours || '-', minutes: simulationConfig?.time_config?.minutes_per_round || '-' }) }}</span>
              </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        {{ t('step2.estimatedDurationAuto', { minutes: Math.round(autoGeneratedRounds * 0.6) }) }}
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">{{ t('step2.customModeHint') }}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">{{ t('step2.visibleAge') }}</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} {{ t('step2.yearsOld') }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ t('step2.visibleGender') }}</span>
              <span class="info-value">{{ genderLabels[selectedProfile.gender] || selectedProfile.gender }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
              <span class="info-label">{{ t('step2.visibleMbti') }}</span>
          ...
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">{{ t('step2.linkedTopics') }}</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.livedExperience') }}</span>
                <span class="dim-desc">{{ t('step2.livedExperienceDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.behaviorProfile') }}</span>
                <span class="dim-desc">{{ t('step2.behaviorProfileDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.memoryImprint') }}</span>
                <span class="dim-desc">{{ t('step2.memoryImprintDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.socialGraph') }}</span>
                <span class="dim-desc">{{ t('step2.socialGraphDesc') }}</span>
              </div>
            </div>
...
watch(currentStage, (newStage) => {
  if (newStage === '生成Agent人设' || newStage === 'generating_profiles') {
    ...
    // 进入配置生成阶段，开始轮询配置
    if (!configTimer) {
      addLog(t('step2.generatingConfig'))
      startConfigPolling()
    }
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(t('step2.startSimulationCustom', { rounds: customMaxRounds.value }))
  } else {
    addLog(t('step2.startSimulationAuto', { rounds: autoGeneratedRounds.value }))
  }
...
const startPrepareSimulation = async () => {
  if (!props.simulationId) {
    addLog(t('step2.missingSimulationId'))
  ...
  // 标记第一步完成，开始第二步
  phase.value = 1
  addLog(t('step2.simulationCreated', { id: props.simulationId }))
  addLog(t('step2.preparingEnvironment'))
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog(t('step2.usingPreparedData'))
      ...
      addLog(`  └─ ${t('step2.taskId', { id: res.data.task_id })}`)
      
      // 立即设置预期Agent总数（从prepare接口返回值获取）
      if (res.data.expected_entities_count) {
        expectedTotal.value = res.data.expected_entities_count
        addLog(t('step2.entitiesRead', { count: res.data.expected_entities_count }))
        if (res.data.entity_types && res.data.entity_types.length > 0) {
          addLog(`  └─ ${t('step2.entityTypes', { types: res.data.entity_types.join(', ') })}`)
        }
      }
      
      addLog(t('step2.pollingProgress'))
      // 开始轮询进度
      startPolling()
      // 开始实时获取 Profiles
    ...
    addLog(t('step2.prepareError', { error: err.message }))
    emit('update-status', 'error')
  }
}
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (data.status === 'completed' || data.status === 'ready' || data.already_prepared) {
        addLog(`✓ ${t('step2.preparationComplete')}`)
        stopPolling()
        stopProfilesPolling()
        await loadPreparedData()
      } else if (data.status === 'failed') {
        addLog(`✗ ${t('step2.preparationFailed', { error: data.error || t('common.unknownError') })}`)
        stopPolling()
        stopProfilesPolling()
      }
    }
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        if (currentCount === 1) {
          addLog(t('step2.profileGenerationStarted'))
        }
        addLog(t('step2.profileGenerated', {
        ...
        if (expectedTotal.value && currentCount >= expectedTotal.value) {
          addLog(`✓ ${t('step2.allProfilesGenerated', { count: currentCount })}`)
        }
      }
    }
  } catch (err) {
    ...
    if (res.success && res.data) {
      ...
      if (data.generation_stage && data.generation_stage !== lastLoggedConfigStage) {
        ...
        if (data.generation_stage === 'generating_profiles') {
          addLog(t('step2.configProfilesStage'))
        } else if (data.generation_stage === 'generating_config') {
          addLog(t('step2.configParamsStage'))
        }
      }
      ...
      if (data.config_generated && data.config) {
        ...
        addLog(`✓ ${t('step2.configGenerated')}`)
        
        // 显示详细配置摘要
        if (data.summary) {
          addLog(`  ├─ ${t('step2.summaryAgents', { count: data.summary.total_agents })}`)
          addLog(`  ├─ ${t('step2.summaryHours', { hours: data.summary.simulation_hours })}`)
          addLog(`  ├─ ${t('step2.summaryInitialPosts', { count: data.summary.initial_posts_count })}`)
          addLog(`  ├─ ${t('step2.summaryHotTopics', { count: data.summary.hot_topics_count })}`)
          addLog(`  └─ ${t('step2.summaryPlatforms', {
            twitter: data.summary.has_twitter_config ? t('step2.summaryStatusOn') : t('step2.summaryStatusOff'),
            reddit: data.summary.has_reddit_config ? t('step2.summaryStatusOn') : t('step2.summaryStatusOff')
          })}`)
        }
        ...
        if (data.config.time_config) {
          ...
          addLog(t('step2.timeConfigSummary', {
        ...
        if (data.config.event_config?.narrative_direction) {
          ...
          addLog(t('step2.narrativeSummary', {
            text: narrative.length > 50 ? narrative.substring(0, 50) + '...' : narrative
          }))
        }
        
        stopConfigPolling()
        phase.value = 4
        addLog(`✓ ${t('step2.environmentReady')}`)
...
const loadPreparedData = async () => {
  phase.value = 2
  addLog(t('step2.loadedExistingConfig'))
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        addLog(`✓ ${t('step2.configLoaded')}`)
        
        // 显示详细配置摘要
        if (res.data.summary) {
          addLog(`  ├─ ${t('step2.summaryAgents', { count: res.data.summary.total_agents })}`)
          addLog(`  ├─ ${t('step2.summaryHours', { hours: res.data.summary.simulation_hours })}`)
          addLog(`  └─ ${t('step2.summaryInitialPosts', { count: res.data.summary.initial_posts_count })}`)
        }
        ...
        addLog(t('step2.waitingForConfig'))
        startConfigPolling()
      }
    }
  } catch (err) {
...
onMounted(() => {
  // 自动开始准备流程
  if (props.simulationId) {
    addLog(t('step2.initializingStep2'))

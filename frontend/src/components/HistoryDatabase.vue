<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">{{ $t('history.sectionTitle') }}</span>
      <div class="section-line"></div>
    </div>
        ...
        <div class="card-header">
          ...
          <div class="card-status-icons">
            <span 
              ...
              :title="$t('history.titleGraph')"
            >◇</span>
            <span 
              class="status-icon available" 
              :title="$t('history.titleEnv')"
            >◈</span>
            <span 
              class="status-icon" 
              :class="{ available: project.report_id, unavailable: !project.report_id }"
              :title="$t('history.titleReport')"
            >◆</span>
          </div>
        </div>
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <div v-if="project.files.length > 3" class="files-more">
              {{ $t('history.moreFiles', { n: project.files.length - 3 }) }}
            </div>
          </div>
          <!-- 无文件时的占位 -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                ...
                <div class="modal-empty" v-else>{{ $t('history.noLinkedFiles') }}</div>
              </div>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                <span class="btn-step">{{ $t('history.modalStep1') }}</span>
              ...
              >
                <span class="btn-step">{{ $t('history.modalStep2') }}</span>
                <span class="btn-icon">◈</span>
              ...
              >
                <span class="btn-step">{{ $t('history.modalStep4') }}</span>
                <span class="btn-icon">◆</span>
...
const getSimulationTitle = (requirement) => {
  if (!requirement) return t('common.unnamedSimulation')
...
const formatRounds = (simulation) => {
  ...
  return t('common.roundsShort', { current, total })
}
...
const truncateFilename = (filename, maxLength) => {
  if (!filename) return t('common.unknownFile')

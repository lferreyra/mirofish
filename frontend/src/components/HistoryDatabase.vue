        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <!-- 文件列表 -->
              <div class="modal-section">
                <div class="modal-label">{{ $t('history.modalFiles') }}</div>
                ...
                <div class="modal-empty" v-else>{{ $t('history.modalNoFiles') }}</div>
              </div>
            </div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">{{ $t('history.modalPlaybackTitle') }}</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">{{ $t('history.modalBtnGraphBuild') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">{{ $t('history.modalBtnEnvSetup') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">{{ $t('history.modalBtnReport') }}</span>
              </button>
            </div>
            <!-- 不可回放提示 -->
            <div class="modal-playback-hint">
              <span class="hint-text">{{ $t('history.modalPlaybackHint') }}</span>
            </div>
          </div>
        </div>
      </Transition>
...
const formatRounds = (simulation) => {
  ...
  return t('history.roundsFormat', { current, total })
}

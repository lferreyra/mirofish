        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <div v-if="project.files.length > 3" class="files-more">
              {{ $t('history.filesMore', { n: project.files.length - 3 }) }}
            </div>
          </div>
          <!-- 无文件时的占位 -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">{{ $t('history.goToGraphBuild') }}</span>
              </button>
              <button
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">{{ $t('history.goToEnvSetup') }}</span>
              </button>
              <button
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">{{ $t('history.goToReport') }}</span>
              </button>
            </div>
            <!-- 不可回放提示 -->
...
const formatRounds = (simulation) => {
  ...
  return t('history.roundsDisplay', { current, total })
}

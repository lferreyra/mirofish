<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">{{ t('history.simulationRecords') }}</span>
      <div class="section-line"></div>
    </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                <div class="modal-label">{{ t('history.simulationRequirement') }}</div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">{{ t('history.simulationReplay') }}</span>
              <span class="divider-line"></span>
            </div>

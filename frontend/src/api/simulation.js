...
/**
 * Prepare the simulation environment as an async task.
...
/**
 * Fetch the in-progress simulation config in real time.
 * @param {string} simulationId
...
/**
 * Fetch detailed run status, including recent actions.
 * @param {string} simulationId
 */
...
/**
 * Fetch simulation history with project details.
 * Used on the home page history view.
 * @param {number} limit - Result limit
 */

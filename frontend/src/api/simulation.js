...
/**
 * Fetch in-progress simulation configuration in real time
 * @param {string} simulationId
 * @returns {Promise} Returns configuration metadata and content
 */
...
/**
 * Fetch real-time simulation run status
 * @param {string} simulationId
 */
...
/**
 * Fetch the simulation timeline grouped by round
 * @param {string} simulationId
 ...
 * Used for the history section on the home page

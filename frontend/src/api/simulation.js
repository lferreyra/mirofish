...
/**
 * Realtime fetch of generating Agent Profiles
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Realtime fetch of generating simulation config
 * @param {string} simulationId
...
/**
 * Get simulation run detailed status (with recent actions)
 * @param {string} simulationId
 */
 ...
 * For homepage history project display

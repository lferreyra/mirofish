export default {
  ...
  step4: {
    ...
    // Panorama display
    activeMemory: '当前有效记忆',
    historicalMemory: '历史记忆',
    involvedEntities: '涉及实体',
    noActiveMemory: '暂无当前有效记忆',
    noHistoricalMemory: '暂无历史记忆',
    noEntities: '暂无涉及实体',
    // Insight display
    ...
    relationChains: '关系链',
    subQueries: '子问题',
    latestKeyFacts: '时序记忆中所关联的最新关键事实',
    driftSubQueries: '漂移查询生成分析子问题',
    noKeyMemory: '暂无当前关键记忆',
    noCoreEntities: '暂无核心实体',
    noRelationChains: '暂无关系链',

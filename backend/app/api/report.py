    ...
    try:
        ...
        return jsonify({
            ...
            "data": {
                ...
                "task_id": task_id,
                "status": "generating",
                "message": "Report generation task has been started. Check progress via /api/report/generate/status",
...
def get_console_log(report_id: str):
    ...
    Retrieve the console output (INFO, WARNING, etc.) from the report generation process in real-time.
    This is different from the structured JSON logs returned by the agent-log endpoint;

...
# Adding this prefix prevents Agent from calling tools
...
def get_graph_entities(graph_id: str):
    ...
    Only returns nodes matching predefined entity types
...
def create_simulation():
    ...
    Note: Parameters like max_rounds are intelligently generated by LLM

...
CHINA_TIMEZONE_CONFIG = {
    ...
    "activity_multipliers": {
        "dead": 0.05,      # Almost nobody during late night
...
class TimeSimulationConfig:
    ...
    off_peak_activity_multiplier: float = 0.05  # Very low activity during late night
...
- The user base is Chinese, so the schedule should follow Beijing Time daily habits
- Almost no activity between midnight 0-5 AM (activity coefficient 0.05)
- Gradually active from 6-8 AM (activity coefficient 0.4)
- Moderately active during work hours 9 AM-6 PM (activity coefficient 0.7)
- Peak period during evening 7-10 PM (activity coefficient 1.5)
- Activity declines after 11 PM (activity coefficient 0.5)
- General pattern: low activity late night, increasing in morning, moderate during work, evening peak
- **Important**: The example values below are for reference only. You need to adjust the specific time slots based on the nature of the event and characteristics of the participant groups.
  - For example: student groups may peak at 9-11 PM; media may be active all day; official institutions only during work hours
  - For example: breaking hot topics may cause late-night discussions, off_peak_hours can be shortened accordingly
...
- reasoning (string): Brief explanation of why this configuration was chosen"""
        ...
        system_prompt = "You are a social media simulation expert. Return pure JSON format. Time configuration should follow Chinese daily schedule habits."
    ...
    def _parse_time_config(self, result: Dict[str, Any], num_entities: int) -> TimeSimulationConfig:
        ...
        return TimeSimulationConfig(
            ...
            off_peak_activity_multiplier=0.05,  # Almost nobody during late night
...
- **Schedule follows Chinese daily habits**: Almost no activity from midnight to 5 AM, most active during evening 7-10 PM
...
{{
    "agent_configs": [
        ...
        system_prompt = "You are a social media behavior analysis expert. Return pure JSON. Configurations should follow Chinese daily schedule habits."
    ...
    def _generate_agent_config_by_rule(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        if entity_type in ["university", "governmentagency", "ngo"]:
            ...
            # Experts/Professors: active during work hours + evening, medium frequency
            return {
                "activity_level": 0.4,
                "posts_per_hour": 0.3,

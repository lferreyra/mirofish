...
class ReportAgent:
    ...
    def __init__(
        ...
        kuzu_tools: Optional[KuzuToolsService] = None
    ):
        """
        ...
        Args:
            ...
            kuzu_tools: Kuzu tools service (optional)
        """
        ...
        self.kuzu_tools = kuzu_tools or KuzuToolsService()
    ...
    def _execute_tool(self, tool_name: str, parameters: Dict[str, Any], report_context: str = "") -> str:
        ...
        try:
            if tool_name == "insight_forge":
                ...
                result = self.kuzu_tools.insight_forge(
                    graph_id=self.graph_id,
                    query=query,
                    simulation_requirement=self.simulation_requirement,
                    report_context=ctx
                ...
                result = self.kuzu_tools.panorama_search(
                    graph_id=self.graph_id,
                    query=query,
                ...
                if isinstance(limit, str):
                    limit = int(limit)
                result = self.kuzu_tools.quick_search(
                    graph_id=self.graph_id,
                    query=query,
                    limit=limit
                )
                ...
                result = self.kuzu_tools.interview_agents(
                    simulation_id=self.simulation_id,
            ...
            # ========== Backward-compatible legacy tools (internally redirect to new tools) ==========
                ...
                result = self.kuzu_tools.get_graph_statistics(self.graph_id)
                return json.dumps(result, ensure_ascii=False, indent=2)

            elif tool_name == "get_entity_summary":
                entity_name = parameters.get("entity_name", "")
                result = self.kuzu_tools.get_entity_summary(
                    graph_id=self.graph_id,
                ...
                nodes = self.kuzu_tools.get_entities_by_type(
                    graph_id=self.graph_id,
    ...
    def plan_outline(
        ...
        context = self.kuzu_tools.get_simulation_context(
            graph_id=self.graph_id,
            simulation_requirement=self.simulation_requirement
        )

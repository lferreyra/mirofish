...
1. InsightForge (deep insight retrieval) - The most powerful hybrid retrieval, automatically generates sub-queries and searches across multiple dimensions
...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-queries, along with an integrated analysis.
    """
    query: str
...
class InterviewResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"**Interviewee Count:** {self.interviewed_count} / {self.total_agents} simulated agents",
...
class ZepToolsService:
    ...
    4. interview_agents - In-depth interview (interview simulated agents, get multi-perspective insights)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Fetches all edges of the graph, then filters those related to the specified node.
    ...
    def get_entity_summary(
        ...
        """
        Get the relationship summary of a specified entity.
    ...
    def insight_forge(
        ...
        The most powerful hybrid retrieval function that automatically decomposes questions and retrieves across multiple dimensions:
...
Return a JSON-formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        Get a full panoramic view, including all relevant content and historical/expired information:
        1. Get all relevant nodes
        2. Get all edges (including expired/invalidated ones)
        3. Categorize and organize active and historical information

        This tool is suitable for scenarios requiring understanding the full picture of events and tracking their evolution.
        ...
        for edge in all_edges:
            ...
            if is_historical:
                # Historical/expired fact, add temporal marker
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean JSON tool call wrapping from agent responses and extract actual content."""
    ...
    def _select_agents_for_interview(
        ...
        Returns:
            tuple: (selected_agents, selected_indices, reasoning)
                ...
                - selected_indices: List of indices for selected agents (for API calls)
...
Please select up to {max_agents} agents most suitable for the interview and explain the selection reasoning."""

    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                # Filter garbage content containing question numbers
                skip = False
                for d in '123456789':
...
class ZepToolsService:
    ...
    - get_node_detail - Get node detail info
    ...
    def search_graph(
        ...
        Uses hybrid search (semantic+BM25) to search for related information in graph.
    ...
    def _local_search(
        ...
        Gets all edges/nodes and performs local keyword matching
    ...
    def get_all_nodes(self, graph_id: str) -> List[NodeInfo]:
        """
        Get all nodes from graph (paginated)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges from graph (paginated, with temporal information)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Gets all edges from the graph, then filters for edges related to the specified node
        ...
        try:
            # Get all edges from graph, then filter
            all_edges = self.get_all_edges(graph_id)
    ...
    def get_entity_summary(
        ...
        # First search for entity-related info
        ...
        # Try to find entity in all nodes
        all_nodes = self.get_all_nodes(graph_id)
        entity_node = None
        for node in all_nodes:
    ...
    def get_simulation_context(
        ...
        # Search for simulation requirement related info
        search_result = self.search_graph(
            graph_id=graph_id,
...
Return sub-question list in JSON format."""
    ...
    def interview_agents(
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Clean up response text: remove markers, numbering, Markdown and other noise
                ...
                # Strategy 2 (supplementary): Properly paired Chinese quotes
                if not key_quotes:
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean JSON tool call wrappers from Agent replies, extract actual content"""
...
- Do not use dividers (---, ***)
- Use Chinese quotation marks when quoting interviewees
- Can use **bold** for keywords, but avoid other Markdown syntax"""

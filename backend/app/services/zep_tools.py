...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-queries, plus integrated analysis
    """
    query: str
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                # Filter out garbage content containing question numbers (Questions 1-9)
                skip = False
                for d in '123456789':
...
class ZepToolsService:
    ...
    2. panorama_search - Breadth search (get the full picture, including expired content)
    3. quick_search - Simple search (fast retrieval)
    4. interview_agents - Deep interview (interview simulated Agents, get multi-perspective insights)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges in the graph (fetched with pagination, includes temporal information)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Retrieves all edges in the graph and filters for those related to the specified node
    ...
    def insight_forge(
        ...
        # Step 3: Extract relevant entity UUIDs from edges; only get info for these entities (not all nodes)
        entity_uuids = set()
        ...
        # Get details for all relevant entities (no count limit, full output)
        entity_insights = []
    ...
    def _generate_sub_queries(
        ...
        Decomposes complex questions into multiple independently retrievable sub-questions
        """
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        Get the full picture view, including all related content and historical/expired information:
        ...
        This tool is suitable for scenarios that need to understand the full picture of an event or track its evolution.
    ...
    def interview_agents(
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Clean response text: remove markers, numbers, Markdown and other noise
                ...
                # Strategy 2 (supplementary): Long text inside correctly paired Chinese quotes 「」
                if not key_quotes:
            ...
            result.summary = f"Interview failed: {str(e)}. The simulation environment may have closed, please ensure the OASIS environment is running."
            return result
        except Exception as e:
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean up JSON tool call wrapping from Agent response and extract actual content"""
    ...
    def _select_agents_for_interview(
        ...
        Returns:
            tuple: (selected_agents, selected_indices, reasoning)
                - selected_agents: List of complete information for selected Agents
...
Please generate 3-5 interview questions."""
        ...
        try:
            ...
            return [
                ...
                "What do you think should be done to address or improve this issue?"
            ]
...
- Use quotation marks when quoting interviewees verbatim

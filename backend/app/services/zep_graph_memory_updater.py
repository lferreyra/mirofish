...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        """
        Convert activity to text description suitable for sending to Zep

        Uses natural language description format so Zep can extract entities and relationships.
        No simulation-related prefixes are added to avoid misleading graph updates.
        """
...
class ZepGraphMemoryUpdater:
    ...
    into the Zep graph in real time.
    Groups by platform; batches activities and sends them to Zep after accumulating BATCH_SIZE entries.
    ...
    # Batch send size (how many entries to accumulate per platform before sending)
    BATCH_SIZE = 5
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        self._total_items_sent = 0  # Activity entries successfully sent to Zep
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args includes full context (e.g. post content, usernames).

        Args:
            activity: Agent activity record
        """
        # Skip DO_NOTHING action types
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "items_sent": self._total_items_sent,        # Activity entries successfully sent
            "failed_count": self._failed_count,          # Batches that failed to send
            "skipped_count": self._skipped_count,        # Activities filtered/skipped (DO_NOTHING)

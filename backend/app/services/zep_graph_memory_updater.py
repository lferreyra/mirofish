...
Dynamically update agent activities from simulation into the Zep graph
"""
...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform, and sends batch updates to Zep after accumulating BATCH_SIZE activities.

    All meaningful actions are updated to Zep, with action_args containing full context information:
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context information (e.g., original post content, usernames, etc.).

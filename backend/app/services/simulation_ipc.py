...
Implemented via simple file-based command/response pattern:
...
class SimulationIPCClient:
    ...
    Used to send commands to simulation process and wait for response
    """
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview both platforms in dual-platform simulation, or the platform in single-platform simulation
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: Each agent interviews both platforms in dual-platform simulation
            timeout: Timeout

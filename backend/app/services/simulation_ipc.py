...
3. Flask polls the response directory for results
"""
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: In dual-platform simulation, interview on both platforms; in single-platform, interview on that platform
            timeout: Timeout in seconds
...
class SimulationIPCServer:
    ...
    def poll_commands(self) -> Optional[IPCCommand]:
        """
        Poll command directory and return the first pending command

    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Target platform (optional)
                ...
                - None: In dual-platform simulation, interview both platforms; in single-platform simulation, interview that platform
            timeout: Timeout in seconds

        Returns:
            IPCResponse, where the result field contains the interview results
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional; overridden by each interview item's platform)
                - "twitter": Default to interviewing the Twitter platform only
                - "reddit": Default to interviewing the Reddit platform only
                - None: In dual-platform simulation, interview both platforms per agent
            timeout: Timeout in seconds

        Returns:
            IPCResponse, where the result field contains all interview results
        """

...
Handles inter-process communication between Flask backend and simulation scripts
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        raise TimeoutError(f"Command response timed out ({timeout}s)")
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview on both platforms in dual-platform mode, or the active platform in single-platform mode
            timeout: Timeout in seconds
...
class SimulationIPCServer:
    """
    Simulation IPC server (used by simulation scripts)

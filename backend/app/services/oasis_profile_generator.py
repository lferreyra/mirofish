...
class OasisProfileGenerator:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """获取系统提示词"""
        base_prompt = "You are a social media user persona generation expert. Generate detailed, realistic personas for opinion simulation, faithfully reflecting known real-world information. You must return valid JSON format. All string values must not contain unescaped newlines."
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for the entity, faithfully reflecting known real-world information.
...
2. persona: Detailed persona description (~2000 characters of plain text), including:
   ...
   - Stance and viewpoints (attitude toward the topic, content that may provoke/move them)
   - Unique characteristics (catchphrases, special experiences, personal hobbies)
   - Personal memories (an important part of the persona — describe the individual's connection to the event and their existing actions and reactions in the event)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for the organization/group entity, faithfully reflecting known real-world information.
...
2. persona: Detailed account profile description (~2000 characters of plain text), including:
   - Organization basics (official name, nature of organization, founding background, main functions)
   ...
   - Special notes (demographics of the represented group, operational habits)
   - Organizational memories (an important part of the persona — describe the organization's connection to the event and its existing actions and reactions in the event)
3. age: Always set to 30 (virtual age for organizational accounts)
4. gender: Always set to "other" (organizational accounts use "other" to indicate non-individual)
...
- The organizational account's posts must align with its identity and positioning"""

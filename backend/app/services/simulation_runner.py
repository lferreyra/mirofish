...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        if not os.path.exists(config_path):
            raise ValueError(f"Simulation config does not exist. Please call the /prepare endpoint first.")
    ...
    def _check_all_platforms_completed(cls, state: SimulationRunState) -> bool:
        ...
        Determines whether a platform is enabled by checking if its corresponding actions.jsonl file exists
    ...
    def _terminate_process(cls, process: subprocess.Popen, simulation_id: str, timeout: int = 10):
        """
        Cross-platform termination of a process and its child processes
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        """
        Clean up simulation run logs (for forcing a restart of the simulation)
    ...
    def register_cleanup(cls):
        ...
        # In non-debug mode, this env var doesn't exist, so registration is also needed
        ...
        if is_debug_mode and not is_reloader_process:
            _cleanup_registered = True  # Mark as registered to prevent child process from retrying
            return
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: In dual-platform simulation, interview on both platforms and return combined results
    ...
    def close_simulation_env(
        ...
        """
        Close the simulation environment (not stop the simulation process)
    ...
    def get_interview_history(
        ...
        Args:
            ...
            agent_id: Specify Agent ID (optional, only get that Agent's history)

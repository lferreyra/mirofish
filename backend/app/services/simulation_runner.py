...
class SimulationRunner:
    ...
    def _terminate_process(cls, process: subprocess.Popen, simulation_id: str, timeout: int = 10):
        ...
        if IS_WINDOWS:
            ...
            try:
                ...
                logger.warning(f"Process group did not respond to SIGTERM, forcing kill: {simulation_id}")
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        ...
        logger.info(f"Simulation log cleanup done: {simulation_id}, removed files: {cleaned_files}")
    ...
    def register_cleanup(cls):
        ...
        try:
            ...
            # 不在主线程中，只能使用 atexit
            logger.warning("Cannot register signal handler (not main thread); using atexit only")

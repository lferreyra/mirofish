...
Manages parallel dual-platform simulation for Twitter and Reddit
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Steps:
        1. Read and filter entities from the Zep knowledge graph
        2. Generate OASIS Agent Profiles for each entity (optional LLM enhancement, supports parallelism)
        ...
        try:
            ...
            # Set real-time save file path (Reddit JSON format takes priority)

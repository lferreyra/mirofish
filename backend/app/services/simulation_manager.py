...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        2. Generate OASIS Agent Profile for each entity
        ...
        Args:
            ...
            use_llm_for_profiles: Whether to use LLM for profiles
            progress_callback: Progress callback (stage, progress, message)
            parallel_profile_count: Parallel profile count, default 3
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No matching entities found, check if graph was built correctly"
                self._save_simulation_state(state)
                return state
            ...
            # Pass graph_id to enable Zep retrieval
            ...
            # Reddit already saved during generation, save again for completeness
            if progress_callback:
                progress_callback(
            ...
            # Note: Run scripts remain in backend/scripts/
            # simulation_runner runs scripts from scripts/ directory

...
logger = get_logger('arus.simulation')
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No qualifying entities found, please check if the graph is properly built"
                self._save_simulation_state(state)
                return state
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. 激活conda环境: conda activate ARUS\n"

...
Interface 1: Analyze text content and generate entity and relationship type definitions
...
- Student: Students
- Professor: Professors/Scholars
- Journalist: Journalists
- Celebrity: Celebrities/Influencers
...
- Person: Any individual person (use when none of the above specific types apply)
...
- Organization: Any organization (use when none of the above specific types apply)
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Final safeguard to ensure limits are not exceeded (defensive programming)

...
Reads nodes from a Zep knowledge graph and filters out those matching predefined entity types
"""
...
class ZepEntityReader:
    ...
    Main functions:
    1. Read all nodes from a Zep knowledge graph
    2. Filter out nodes matching predefined entity types (nodes whose Labels are not solely "Entity")
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Total nodes fetched: {len(nodes_data)}")
        return nodes_data
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Total edges fetched: {len(edges_data)}")
        return edges_data

    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Get all edges related to a given node (with retry logic)
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If a node's Labels contain only "Entity", it does not match any predefined type and is skipped
        ...
        # Fetch all edges (for later association lookup)
        ...
        for node in all_nodes:
            ...
            # Filtering logic: Labels must contain at least one label other than "Entity" and "Node"
            ...
            if enrich_with_edges:
                ...
                # Fetch basic information for associated nodes
                related_nodes = []
    ...
    def get_entity_with_context(
        ...
        """
        try:
            # Fetch the node with retry logic
            ...
            # Fetch all nodes for association lookup
            all_nodes = self.get_all_nodes(graph_id)
            node_map = {n["uuid"]: n for n in all_nodes}
            ...
            # Fetch associated node information
            related_nodes = []
            for related_uuid in related_node_uuids:
                if related_uuid in node_map:
                    related_node = node_map[related_uuid]

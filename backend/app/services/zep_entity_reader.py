...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        - If a node's labels include tags other than "Entity" and "Node", it matches a predefined type; keep it
        ...
        for node in all_nodes:
            ...
            # Filtering logic: labels must include tags other than "Entity" and "Node"

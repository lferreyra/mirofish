...
Used for persisting project state on the server side, avoiding large data transfers between frontend API calls
"""
...
class ProjectStatus(str, Enum):
    ...
    GRAPH_BUILDING = "graph_building"    # Graph construction in progress

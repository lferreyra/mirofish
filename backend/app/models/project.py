...
Used to persist project state on server side, avoiding passing large amounts of data between interfaces
"""
...
class Project:
    ...
    # Ontology information (filled after interface 1)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None

    # Graph information (filled after interface 2)

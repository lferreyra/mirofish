...
def _fetch_page_with_retry(
    ...
    **kwargs: Any,
    ...
    """Fetch a single page, with exponential backoff retries on failure. Only retries transient network/IO errors."""
    if max_retries < 1:
...
def fetch_all_nodes(
    ...
    """Fetch graph nodes with pagination, returning at most max_items (default 2000). Each page request includes retries."""
    all_nodes: list[Any] = []

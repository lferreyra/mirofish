...
Used to handle retry logic for LLM and other external API calls
"""
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Batch call with individual retries for each failed item

        Args:
            items: List of items to process
            process_func: Processing function that accepts a single item as an argument
            exceptions: Exception types to retry on

...
def _ensure_utf8_stdout():
    ...
    Fix Chinese character garbled issue on Windows console
    """
...
def setup_logger(name: str = 'mirofish', level: int = logging.DEBUG) -> logging.Logger:
    ...
    # If handlers already exist, don't add again
    if logger.handlers:
        return logger
    ...
    # 2. Console handler - simple log (INFO and above)
    # Ensure UTF-8 encoding on Windows to avoid Chinese character garbling
    _ensure_utf8_stdout()

...
class FileParser:
    """File parser for extracting text from various document formats."""
    ...
    def _extract_from_md(file_path: str) -> str:
        """Extract text from a Markdown file with auto encoding detection."""
...
def split_text_into_chunks(
    ...
    while start < len(text):
        ...
        # Advance by (chunk_size - overlap) to create the overlap

...
def create_app(config_class=Config):
    ...
    # Disable ASCII escaping so non-ASCII characters are serialized as-is.
    ...
    # Only log startup info in the reloader child process to avoid duplicate output in debug mode.
    ...
    # Register simulation process cleanup to terminate all simulation processes on shutdown.

"""
Twitter Simulation Preset Script
...
def setup_simulation_logging(log_dir: str):
    ...
    loggers_config = {
        ...
        "simulation.twitter": os.path.join(log_dir, "simulation.twitter.log"),
...
from app.simulation.agent_graph import generate_twitter_agent_graph
...
class TwitterSimulationRunner:
    ...
    def _get_profile_path(self) -> str:
        """Get the profile file path (Twitter uses CSV format)."""
    ...
    def _get_active_agents_for_round(
        ...
        Returns:
            List of active (agent_id, agent) pairs.
        """
...
async def main():
    parser = argparse.ArgumentParser(description='Twitter Simulation')
    parser.add_argument(
        '--config',
        type=str,
        required=True,
